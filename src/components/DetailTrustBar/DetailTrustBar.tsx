...
function DetailTrustBar({
  ...
  return (
    <div className="flex items-center gap-4 rounded-2xl bg-green-50 px-4 py-4">
      ...
      <div className="flex flex-col items-center gap-1 text-center">
        ...
        <p className="text-xs font-semibold text-green-600">{power}</p>
      </div>
      ...
      <div className="flex flex-col items-center gap-1 text-center">
        ...
        <p className="text-xs font-semibold text-green-600">{security}</p>
      </div>
