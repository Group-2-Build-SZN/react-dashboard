...
export function ContactUsScreen({ heroImageUrl, methods, onBack, onSelectMethod, onNavigateTab }: ContactUsScreenProps) {
    ...
    return (
        <div className="contact-screen">
            ...
            <BottomNav active={activeNav} onChange={(tab) => { setActiveNav(tab); onNavigateTab?.(tab); }} />
        </div>
    );
}