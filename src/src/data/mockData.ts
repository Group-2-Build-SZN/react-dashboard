...
export const mockPaymentSteps: PaymentStep[] = [
  {
    ...
    subtitle: 'Securely connecting to Paystack',
    status: 'complete',
  },
  {
    id: 'verifying_card',
    title: 'Verifying Card Details',
    subtitle: 'Verifying your card information',
    status: 'complete',
  },
  {
    id: 'processing',
  ...
  },
  {
    ...
    subtitle: 'Connecting your bank for approval',
    status: 'pending',
  },
  {
    id: 'finalizing',
    title: 'Finalizing',
    subtitle: 'Completing your transaction',
    status: 'pending',
  },
];
...
export const mockContactMethods: ContactMethod[] = [
  ...
  },
  {
    ...
    detail: 'No. 12 Park Avenue, Enugu, Enugu State',
  },
];
...
export const mockSavedProperties: Property[] = [
  {
    ...
    listingTitle: '4 Bedroom Duplex',
    neighborhood: 'New Haven, Enugu',
  ...
  },
  {
    ...
    listingTitle: '3 Bedroom Bungalow',
    neighborhood: 'G.R.A, Enugu',
    address: 'G.R.A, Enugu',
    price: 1800000,
  ...
  },
  {
    ...
    listingTitle: 'Luxury Pool Villa',
    neighborhood: 'Independence Layout, Enugu',
